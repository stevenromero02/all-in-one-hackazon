...
if [ SECRET2_VALUE=1 ]
then
	cp /vulnerabilities/xss_accountv1.php /var/www/hackazon/assets/config/vuln/account.php
	cp /vulnerabilities/xss_contactv1.php /var/www/hackazon/assets/config/vuln/contact.php
...
if [ SECRET2_VALUE=2 ]
then
	cp /vulnerabilities/xss_accountv2.php /var/www/hackazon/assets/config/vuln/account.php
	cp /vulnerabilities/xss_contactv3.php /var/www/hackazon/assets/config/vuln/contact.php
	cp /vulnerabilities/xss_amfv2.php /var/www/hackazon/assets/config/vuln/amf.php
...
if [ SECRET2_VALUE=3 ]
then
	cp /vulnerabilities/xss_accountv3.php /var/www/hackazon/assets/config/vuln/account.php
	cp /vulnerabilities/xss_contactv2.php /var/www/hackazon/assets/config/vuln/contact.php
	cp /vulnerabilities/xss_amfv1.php /var/www/hackazon/assets/config/vuln/amf.php
...
if [ SECRET2_VALUE=4 ]
then
	cp /vulnerabilities/xss_accountv4.php /var/www/hackazon/assets/config/vuln/account.php
	cp /vulnerabilities/xss_contactv4.php /var/www/hackazon/assets/config/vuln/contact.php
	cp /vulnerabilities/xss_amfv2.php /var/www/hackazon/assets/config/vuln/amf.php
	cp /vulnerabilities/xss_cartv1.php /var/www/hackazon/assets/config/vuln/cart.php
...
if [ SECRET2_VALUE=5 ]
then
	cp /vulnerabilities/xss_accountv5.php /var/www/hackazon/assets/config/vuln/account.php
	cp /vulnerabilities/xss_contactv1.php /var/www/hackazon/assets/config/vuln/contact.php
	cp /vulnerabilities/xss_amfv1.php /var/www/hackazon/assets/config/vuln/amf.php
	cp /vulnerabilities/xss_cartv2.php /var/www/hackazon/assets/config/vuln/cart.php
	cp /vulnerabilities/xss_checkoutv1.php /var/www/hackazon/assets/config/vuln/checkout.php
